...
class GuestProfileRequest extends FormRequest
{
    ...
    public function rules()
    {
        if( (in_array($this->method(), ['PUT', 'PATCH']))){
            ...
            return [
            'Profile_no' => 'nullable|min:1|max:100|unique:guest_profiles,Profile_no,'.$this->segment(3),
            'first_name' => 'nullable|min:3|max:50',
            'last_name' => 'nullable|min:3|max:50',
            'id_no' => 'nullable|min:1|max:100|unique:guest_profiles,id_no,'.$this->segment(3),
