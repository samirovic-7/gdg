...
export default {
  ...
  methods:{
    ...
    async getAllPaginate(){
      ...
      axios
        .get(`api/sourcebusinessPagination/${this.pageSize}`)
        .then(response => {
    ...
    nextPage(page, query) {
      ...
      axios
        .get(`api/sourcebusinessPagination/${page}?page=${query}`)
        .then(response => {
          if (response.status == 200){
            (this.pagi = response.data.data,
                this.pageInfo = response.data
    ...
    getAllSourcebusiness(){
      ...
      this.count = this.bussiness.length
    },
    ...
    deleteData(){
      axios
        .delete(`api/sourcebusiness/${this.Bussid}`)
    ...
    async updateUser() {
      ...
      try {
        const user = await axios.put(
          `api/sourcebusiness/${this.Bussid.id}`,
          {
            name: this.name_edit,
